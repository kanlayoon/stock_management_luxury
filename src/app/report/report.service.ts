...
export class ReportService {
  ...
  public report_supply = (obj:any): Observable<any[]> =>  {
    ...
    return this._http.post(this.actionUrl + "/report/supply" , obj)
 ...
 public report_req = (obj:any): Observable<any[]> =>  {
  let headers = new Headers({'Content-Type': 'application/json'});
  let options = new RequestOptions({ headers: headers });
  return this._http.post(this.actionUrl + "/report/req" , obj)
  .map( (response: Response) => <any>response.json() )
  .do( x => console.log(x));
}
public report_reservation = (obj:any): Observable<any[]> =>  {
  let headers = new Headers({'Content-Type': 'application/json'});
  let options = new RequestOptions({ headers: headers });
  return this._http.post(this.actionUrl + "/report/reservation" , obj)
  .map( (response: Response) => <any>response.json() )
  .do( x => console.log(x));
}
public report_use = (obj:any): Observable<any[]> =>  {
  let headers = new Headers({'Content-Type': 'application/json'});
  let options = new RequestOptions({ headers: headers });
  return this._http.post(this.actionUrl + "/report/use" , obj)
  .map( (response: Response) => <any>response.json() )
  .do( x => console.log(x));
}
public report_reservation_stat = (obj:any): Observable<any[]> =>  {
  let headers = new Headers({'Content-Type': 'application/json'});
  let options = new RequestOptions({ headers: headers });
  return this._http.post(this.actionUrl + "/report/reservation/statistic" , obj)
  .map( (response: Response) => <any>response.json() )
  .do( x => console.log(x));
}
